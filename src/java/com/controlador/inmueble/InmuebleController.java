...
import com.controlador.inmueble.util.JsfUtil;
import com.controlador.inmueble.util.JsfUtil.PersistAction;
...
public class InmuebleController implements Serializable {
    ...
    @EJB
    private com.controlador.inmueble.InmuebleFacade ejbFacade;
